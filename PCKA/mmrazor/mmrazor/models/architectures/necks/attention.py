...
from mmrazor.models.architectures.necks.layer import DropPath
...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        if self.shifted:
            mask = mask + self._upper_lower_mask(new_h // p, new_w // p, p, p, self.d, x.device)
            mask = mask + self._left_right_mask(new_h // p, new_w // p, p, p, self.d, x.device)
