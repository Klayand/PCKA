...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_pkd_fpn0=dict(type='KLDivergence', loss_weight=1.0),
            loss_pkd_fpn1=dict(type='KLDivergence', loss_weight=1.0),
            loss_pkd_fpn2=dict(type='KLDivergence', loss_weight=1.0),
            loss_pkd_fpn3=dict(type='KLDivergence', loss_weight=1.0)),
