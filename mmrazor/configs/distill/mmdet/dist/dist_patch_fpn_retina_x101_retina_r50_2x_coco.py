...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_pkd_fpn0=dict(type='DISTLoss_patch', inter_loss_weight=1.0, intra_loss_weight=1.0, tau=4),
            loss_pkd_fpn1=dict(type='DISTLoss_patch', inter_loss_weight=1.0, intra_loss_weight=1.0, tau=4),
            loss_pkd_fpn2=dict(type='DISTLoss_patch', inter_loss_weight=1.0, intra_loss_weight=1.0, tau=4),
