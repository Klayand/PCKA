...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_pkd_fpn0=dict(type='ATLoss_patch', loss_weight=1.0),  # mmd loss 300
            loss_pkd_fpn1=dict(type='ATLoss_patch', loss_weight=1.0),  # at loss 30000
            loss_pkd_fpn2=dict(type='ATLoss_patch', loss_weight=1.0),
